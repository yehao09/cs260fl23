...
class Implicant:
    ...
    def get_implicant_bin_repr(self):
        ...
        # result = [ 0 if element[-1] == "'" else 1 for element in self.implicant ]
        return tuple(result)

    def set_cover(self, covered_minterms):
        '''
        convert self.implicant_bin to decimal and return
    ...
    def simplify(self, another_implicant):
        ...
        while index < len(self.implicant):
            if self.implicant[index] == another_implicant.implicant[index]:
                ...
                # result = result + self.implicant[index]
            else:
...
if __name__ == "__main__":
    ...
    # --> object of implicant class, result.get() --> ("b","c'")
